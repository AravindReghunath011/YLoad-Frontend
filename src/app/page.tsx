...
No credentials required—just approval for a hassle-free experience!</p>
            ...
            <Button  className={'bg-[#121212] text-white p-5 hover:bg-[#121212] hover:border-neutral-700 border w-36 shadow'}>Sign up</Button>
            <Link href={'/upload'}> <Button className={'bg-green-800 border border-green-700 hover:bg-green-800  hover:border-green-600 p-5 w-36 text-white'}>Upload a video</Button></Link>

            </div>
            <div className='w-[50%] mt-16 text-xl'>

            <Marquee gradient={true} gradientColor='#121212' gradientWidth={300}>
                Y-Load &nbsp; Y-Load &nbsp;Y-Load &nbsp;Y-Load &nbsp;Y-Load &nbsp;Y-Load &nbsp;Y-Load &nbsp; <br />
                Y-Load &nbsp; Y-Load &nbsp;Y-Load &nbsp;Y-Load &nbsp;Y-Load &nbsp;Y-Load &nbsp;<br />
                Y-Load &nbsp;Y-Load &nbsp;Y-Load &nbsp;Y-Load &nbsp;Y-Load &nbsp;Y-Load &nbsp;Y-Load &nbsp;<br />
                Y-Load &nbsp; <br />
                Y-Load &nbsp;<br />
            </Marquee>
